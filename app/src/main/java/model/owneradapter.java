...
import com.login_signup_screendesign_demo.housedetailsforowner;
import com.squareup.picasso.Picasso;

import java.util.ArrayList;
import java.util.List;

public class owneradapter extends RecyclerView.Adapter<owneradapter.MyViewHolder> implements Filterable {
    Context context;
    ...
    public owneradapter(Context c , ArrayList<Rent> r)
    {
        context =c;
        rents = r;
    ...
    public owneradapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new owneradapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.image,parent,false));
    }
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, housedetailsforowner.class);
